Object.defineProperty(Node.prototype, 'a11eObject', {
  get: function() { return a11eObjectFor(this); }
});
...
function a11eObjectFor(aNode)
{
  ...
  if (sobjs.some(function(el) { return el.match != ":role"; } )) {
...
a11eobj.prototype = {
  get role() { return this.prop("role"); },
  ...
  get parent() {
    for (var parentNode = this.DOMNode.parentNode; parentNode;
    ...
    var iterator = {
      next: function() {
        ...
        if (this.cur.nextSibling) {
          ...
          return obj ? { value: obj, done: false } : this.next();
        }
